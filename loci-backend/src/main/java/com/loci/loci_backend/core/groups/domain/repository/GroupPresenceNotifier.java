...
public interface GroupPresenceNotifier {

  void boardcastPresenceChange(GroupSubscriberId subscriberId, GroupPresence presence);
  // subscriberId

  // TODO:
  // void broadcastToRoom(GroupPresence groupPresence);
